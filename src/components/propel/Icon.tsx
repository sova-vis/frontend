...
export const ICON_PATHS: Record<string, string> = {
  ...
  // Brand-banned glyphs (trophy/lightbulb/award/graduation) repointed to
  // on-brand assessment marks so every caller renders compliant imagery.
  trophy: '<circle cx="12" cy="12" r="9"/><path d="M8.5 12.5l2.5 2.5 4.5-5"/>',
  ...
  lightbulb: '<path d="M12 3l1.6 4.8L18 9.4l-4.4 1.6L12 16l-1.6-5L6 9.4l4.4-1.6Z"/><path d="M19 14l.7 2.1L22 17l-2.3.9L19 20l-.7-2.1L16 17l2.3-.9Z"/>',
  flag: '<path d="M5 21V4"/><path d="M5 4h11l-2 3 2 3H5"/>',
  clock: '<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>',
  calendar: '<rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 9h18M8 3v4M16 3v4"/>',
  bolt: '<path d="M13 2 4 14h6l-1 8 9-12h-6Z"/>',
  award: '<circle cx="12" cy="12" r="8.5"/><circle cx="12" cy="12" r="4.5"/><circle cx="12" cy="12" r="1"/>',
  ...
  graduation: '<path d="M4 19.5V5a2 2 0 0 1 2-2h13a1 1 0 0 1 1 1v15"/><path d="M6 17h14"/><path d="M6 21a2 2 0 0 1-2-2 2 2 0 0 1 2-2h14v4Z"/>',
